...
help:
	...
	@echo "  make verify-nightly  floor + input-envelope + concurrency tiers (real verdict; #311)"
	@echo "  make verify-release  nightly + soak (envelope) + latency tiers (real verdict; #311)"
