...
WORD_RE = re.compile(r"[a-z0-9]+")  # lowercase alnum word tokenizer (shared regex; callers differ in stopword/set policy)
SLUG_SCRUB_RE = re.compile(r"[^a-z0-9._-]+")  # chars to strip/replace when building a filesystem-safe slug
