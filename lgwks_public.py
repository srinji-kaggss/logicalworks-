...
def _label_records(records: list[dict], query: str, floor: float = 0.25) -> list[dict]:
    ...
    for r in records:
        ...
        if score < floor:
            ...
            out.append({**r, "ranking": "citation-canon, not relevance", "relevance_score": score, "relevance_floor": floor})
        else:
            out.append({**r, "ranking": "relevance-verified", "relevance_score": score, "relevance_floor": floor})
    return out
